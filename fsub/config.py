...
FORCE_MESSAGE = os.getenv(
    ...
    "Halo {mention}!"
    "\n\n"
    "Anda harus bergabung di Channel/Group terlebih dahulu , Atau Join Vip Untuk Melihat Video Nya."
    "\n\n"
    "Silakan Join Ke Channel dan Groupnya di Bawah Ini Terlebih Dahulu.",
    )
